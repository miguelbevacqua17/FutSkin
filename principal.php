<?php
    ...
    // Traemos las funciones como valores de variables. 
            ...
            <div class="row p-3">
                ...
                <div class="col-lg-6 mb-0 d-flex align-items-center">
                    <div class="text-align-left align-self-center">
                        ...
                        <p>Las mejores camisetas orignales para alentar a tu equipo en todo momento.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">Principales categorías</h1>
                    <p>Encontrá a tu equipo</p>
            </div>
        </div>
        <div class="row"><?php echo $categoriasHTML ?></div>
    </section>
    <!-- FIN CATEGORIAS -->
    ...
    <footer class="bg-dark" id="tempaltemo_footer">
            ...
            <div class="row">
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><i class="fas fa-map-marker-alt fa-fw"></i>Dirección</li>
                        <li><i class="fa fa-phone fa-fw"></i><a class="text-decoration-none" href="tel:">4200 - 7777</a></li>
                        <li><i class="fa fa-envelope fa-fw"></i><a class="text-decoration-none" href="mailto:info@company.com">contacto@futskin.com</a></li>
                    </ul>
                </div>
        ...
        <div class="w-100 bg-black py-3">
            <div class="container">
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">Copyright &copy; 2023 FutSkin</p>
                    </div>
                </div>
            </div>
        </div>
