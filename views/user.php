            ...
            <form class="col-md-9 m-auto" method="post" role="form">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="Nombre de usuario">
                    </div>

                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Apellido</label>
                        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="Apellido">
                    </div>
                    

                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Email</label>
                        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="Email">
                    </div>
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" class="btn btn-success btn-lg px-3">Editar datos</button>
                    </div>
                </div>
            </div>
